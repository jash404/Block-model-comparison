    ...
    return (React.createElement("li", { className: `jp-extensionmanager-entry ${flagClasses.join(' ')}`, title: title, style: { display: 'flex' } },
        ...
        React.createElement("div", { className: "jp-extensionmanager-entry-description" },
            React.createElement("div", { className: "jp-extensionmanager-entry-title" },
                ...
                entry.blockedExtensionsEntry && (React.createElement(ToolbarButtonComponent, { icon: listingsInfoIcon, iconLabel: trans.__('%1 extension has been blockedExtensions since install. Please uninstall immediately and contact your blockedExtensions administrator.', entry.name), onClick: () => window.open('https://jupyterlab.readthedocs.io/en/3.2.x/user/extensions.html') })),
                !entry.allowedExtensionsEntry &&
                    viewType === 'installed' &&
                    listMode === 'allow' && (React.createElement(ToolbarButtonComponent, { icon: listingsInfoIcon, iconLabel: trans.__('%1 extension has been removed from the allowedExtensions since installation. Please uninstall immediately and contact your allowedExtensions administrator.', entry.name), onClick: () => window.open('https://jupyterlab.readthedocs.io/en/3.2.x/user/extensions.html') })),
...
function getPrebuiltUninstallInstruction(entry, trans) {
    ...
    read the user guide on:`)),
        React.createElement("p", null,
            React.createElement("a", { href: "https://jupyterlab.readthedocs.io/en/3.2.x/user/extensions.html", target: "_blank", rel: "noopener noreferrer" }, "https://jupyterlab.readthedocs.io/en/3.2.x/user/extensions.html"))));
}
/**
...
administrator to verify the listings configuration.`)),
                    React.createElement("div", null,
                        React.createElement("a", { href: "https://jupyterlab.readthedocs.io/en/3.2.x/user/extensions.html", target: "_blank", rel: "noopener noreferrer" }, this._trans.__('Read more in the JupyterLab documentation.'))))
            ];
        }
